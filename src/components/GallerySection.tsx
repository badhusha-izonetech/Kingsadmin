...
const GallerySection = () => {
    ...
    return (
        <section className="da-section bg-background overflow-hidden" id="gallery">
            <div className="da-container">
                <div className="text-center mb-16">
                    <div className="gold-line w-24 mx-auto mb-6" />
                    <p className="text-primary font-body text-sm tracking-[0.4em] uppercase mb-4">Visual Excellence</p>
                    <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-6">Academy Gallery</h2>
                    <p className="text-muted-foreground max-w-2xl mx-auto font-body text-lg">
                        Experience the vibrant life at Kings Dental Academy through our latest workshops, conferences, and state-of-the-art campus facilities.
                    </p>
                </div>
                ...
                >
                    {filteredItems.map((item, index) => (
                        <motion.div
                            ...
                            viewport={{ once: false }}
                            transition={{ duration: 2.5, delay: (index % 3) * 0.25, ease: [0.2, 0, 0, 1] }}
                            className="group perspective h-[320px] md:h-[400px]"
                ...
                <div className="mt-20 text-center">
                    <Button
                        className="da-button-primary group"
                        onClick={() => window.location.href = "/gallery"}
                    >
                        Explore Full Gallery
                        <Camera className="ml-2 w-5 h-5 transition-transform group-hover:rotate-12" />
                    </Button>
                </div>
            </div>
                    ...
                    {selectedItem && (
                        <div className="relative aspect-video w-full group">
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-8 bg-gradient-to-t from-black via-black/50 to-transparent">
                                ...
                                <p className="text-gray-300 font-body max-w-3xl">{selectedItem.description}</p>
                            </div>
                        </div>
                    )}
                </DialogContent>
